<template>
    ...
    >
        <div class="relative">
            <div class="aspect-w-7 aspect-h-10 blur-[2px]">
                <JPicture :src="item.image.url" :alt="item.title" class="w-full h-full object-cover" />
            </div>
            <div class="absolute inset-0 w-full h-full px-3 md:px-6 xl:px-8 py-3 md:py-5 xl:py-7">
                <div class="bg-white w-full h-full space-y-2.5 pt-2.5 pb-5 px-3 xl:px-[14px]">
