<template>
    <div class="product-gallery">
        ...
        <div v-if="images.length > 1" class="thumbnail-swiper-container mt-4">
            ...
            <!-- Navigation Buttons -->
            <button v-if="images.length > 5" class="thumbnail-prev btn-navigation -left-12" aria-label="Previous">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                </svg>
            </button>
            <button v-if="images.length > 5" class="thumbnail-next btn-navigation -right-12" aria-label="Next">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
